...
const Profile = () => {
	...
	const handleInfoUpdate = useCallback(() => {
		console.log(
			"update profile info asdfasd asdasd asdasdasd asdasdasd sadasda asdasd asd sddfasfda adsfas dasf ds fsd fasd fsd afasd fsda fsd f"
		)
	}, [])
